...
class TronTransactionCheckWorker:
    ...
    def _beat(self):
        ...
        # have invoices - reason to get transactions
        transactions = TronTransactionsGetter.get_all()
        self.log.debug(
        ...
        for invoice in invoices:
            ...
            invoice.paid()
            self.log.info(
                f"Invoice {invoice} has been paid"
            )
    
    @staticmethod
    def _get_new_invoices():
        CREATED = cashier.models.TransactionStatusChoices.CREATED
